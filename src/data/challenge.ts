...
export const CHALLENGE_DAYS: ChallengeDay[] = [
  ...
  { day: 4, week: 1, title: "Your real return", action: "Find your savings account rate. Subtract Bangladesh inflation (~9%). That's your real return.", module: "2" },
  ...
  { day: 25, week: 4, title: "Bangladesh scam research", action: "Search '2024 Bangladesh financial scam'. Read one real story. What was the pattern?", module: "4" },
