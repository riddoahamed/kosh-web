...
import { ArrowLeft, ShieldCheck, BarChart3, Heart, Mail, Globe } from "lucide-react";
      ...
      <main className="max-w-2xl mx-auto px-4 pt-8 pb-16 space-y-16 relative z-[1]">
        ...
        <section className="text-center space-y-4 pb-4">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-center justify-center gap-4">
            <a href="https://www.koshbd.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm font-semibold text-foreground/70 hover:text-foreground transition-colors">
            ...
            <a href="https://www.linkedin.com/company/koshbd/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm font-semibold text-foreground/70 hover:text-foreground transition-colors">
